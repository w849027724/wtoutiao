...
import com.wtoutiao.common.security.exception.*;
...
public class WWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
...
//        }
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new WOAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
                HttpStatus.valueOf(status));
